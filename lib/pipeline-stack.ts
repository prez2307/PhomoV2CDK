...
export class PipelineStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const lambdaSource = pipelines.CodePipelineSource.connection('prez2307/PhomoV2Lambdas', 'main', {
      connectionArn: githubConnectionArn,
    });
    ...
    const pipeline = new pipelines.CodePipeline(this, 'Pipeline', {
      ...
      synth: new pipelines.ShellStep('Synth', {
        input: cdkSource,
        additionalInputs: {
          '../PhomoV2Lambdas': lambdaSource, // Mount lambda repo as sibling directory
        },
        commands: [
          ...
          'ls -la',
          'echo "=== DEBUG: List parent directory ==="',
          'ls -la ..',
          'echo "=== DEBUG: Check if PhomoV2Lambdas exists at ../ ==="',
          'ls -la ../PhomoV2Lambdas || echo "NOT FOUND at ../PhomoV2Lambdas"',
          'echo "=== DEBUG: Check if PhomoV2Lambdas exists at ./ ==="',
          'ls -la ./PhomoV2Lambdas || echo "NOT FOUND at ./PhomoV2Lambdas"',
          'echo "=== DEBUG: Find all PhomoV2Lambdas directories ==="',
          'find .. -name "PhomoV2Lambdas" -type d 2>/dev/null || echo "find failed"',
